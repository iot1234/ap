...
function normaliseRoomForV2(key, room) {
  ...
  return {
    ...
    has_balcony: boolFrom(room.balcony ?? room.hasBalcony, false),
    has_parking: boolFrom(room.parking ?? room.hasParking, false),
    has_kitchen: boolFrom(room.kitchen ?? room.hasKitchen, false),
    has_ac: boolFrom(room.hasAc ?? room.ac, defaults.ac),
