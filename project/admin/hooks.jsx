...
(function () {
  ...
  const ERROR_CODE_MAP = {
    ...
    BILL_FORCE_REASON_REQUIRED: {
      title: 'ต้องระบุเหตุผลก่อน force ออกบิล',
      description: (e) => e.hint || 'การออกบิลข้ามปัญหาสำคัญต้องมีเหตุผลอย่างน้อย 8 ตัวอักษร เพื่อป้องกันบิลผิดและให้ตรวจย้อนหลังได้',
    },
    BILL_NOT_PAYABLE: {
    ...
    CANCEL_REASON_REQUIRED: {
      title: 'ต้องระบุเหตุผลยกเลิก',
      description: (e) => e.hint || 'ใส่เหตุผลยกเลิกอย่างน้อย 5 ตัวอักษร เพื่อแจ้งผู้จองและเก็บ audit ว่าทำไมห้องถูกปล่อยกลับมาว่าง',
    },
    ...
    DUPLICATE_QUICK_INVITE: {
      title: 'มีรายการสัญญาซ้ำอยู่แล้ว',
      description: (e) => e.hint || 'รีเฟรชข้อมูล แล้วตรวจห้อง ผู้เช่า และสัญญาเดิมก่อนสร้างซ้ำ',
    },
  ...
  function humanizeAdminErrorText(text, opts = {}) {
    ...
    const exact = [
      ...
      [/^duplicate constraint$/i, 'ข้อมูลซ้ำกับรายการที่มีอยู่แล้ว กรุณารีเฟรชและตรวจรายการเดิมก่อนทำซ้ำ'],
