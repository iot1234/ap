...
const PAGE_TITLES = {
  ...
  tenants:     'ผู้เช่า',
  bookings:    'การจอง',
  'booking-deposit-settings': 'ตั้งค่าจอง/มัดจำ',
  contracts:               'สัญญา',
  'contract-invitations':  'ใบเชิญให้ผู้เช่ากรอกสัญญา',
  'contract-templates':    'เทมเพลตสัญญา',
...
function App() {
  ...
  const PAGES = {
    ...
    'booking-deposit-settings': window.PageBookingDepositSettings,
    contracts:               window.PageContracts,
    'contract-invitations':  window.PageContractInvitations,
    'contract-templates':    window.PageContractTemplates,
